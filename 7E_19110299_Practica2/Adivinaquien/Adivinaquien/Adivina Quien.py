...
class MiVentana:
    def __init__(self, master, VenIm):
        ...
        self.caracteristicas = list(self.personajes["Capitan"].keys())
    ...
    def registrar_respuesta(self, respuesta):
        ...
        self.respuestas.append((caracteristica, respuesta)) #agregar respuesta
...
class Ventana1_MostrarPers:
    def __init__(self, master):
        ...
        img_Rick = Image.open("capitan.jpg")  
        ...
        img_Morthy = Image.open("chuck.jpg")  
        ...
        img_Summer = Image.open("Clancy.jpg")  
        ...
        img_Beth = Image.open("magistrado.jpg")  
        ...
        img_Jerry = Image.open("pescado.jpg")  
        ...
        img_Jessica = Image.open("trudy.jpg")  
...
class Ventana2_RondaPreg:
    def __init__(self):
        ...
        img_Jerry = Image.open("pescado2.jpg")  
        img_Jerry_tk = ImageTk.PhotoImage(img_Jerry)
